...
#        TX_EXPLORER_URL_PREFIX='http://coinyechain.info/tx/',
        BLOCK_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2761/block/',
        ADDRESS_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2761/address/',
        TX_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2761/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8,
    ),
...
#        BLOCK_PERIOD=150, # s
#        SYMBOL='VTC',
#        CONF_FILE_FUNC=lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Vertcoin') 
#		if platform.system() == 'Windows' else os.path.expanduser('~/Library/Application Support/Vertcoin/') 
#		if platform.system() == 'Darwin' else os.path.expanduser('~/.vertcoin'), 'vertcoin.conf'),
...
#    ),
    ...
    digibyte=math.Object(
        ...
        ADDRESS_EXPLORER_URL_PREFIX='http://altexplorer.net/address/',
        TX_EXPLORER_URL_PREFIX='http://altexplorer.net/tx/',
#        BLOCK_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2762/block/',
#        ADDRESS_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2762/address/',
#        TX_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2762/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.0001,
    ),
