...
nets = dict(
    ...
    infinitecoin=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2758/block/',
        ADDRESS_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2758/address/',
        TX_EXPLORER_URL_PREFIX='http://p2pool.freeyy.me:2758/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8,
    ),
